...
<script>
  ...
  <title>cabinet</title>
   ...
   <body>
     ...
     <noscript><iframe id="localize_iframe" src="https://www.googletagmanager.com/ns.html?id=GTM-MG3RRWK"
...
<script>
  ...
  function receiveMessage(event) {
    if (event.origin !== "https://kinostelux.lu")
      return;
