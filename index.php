  ...
  <body>   
    ...
    <form name="form" >
      <select size="1" id="select" onChange="location = this.options[this.selectedIndex].value;">
        <option selected="true" disabled="disabled">Prendre rendez-vous</option> 
        <option value="./gregorytest.php" >Gregory Berghman</option>
        <option value="./cabinettest.php" >Toutes les disponibilités</option>
      </select>
    </form>
